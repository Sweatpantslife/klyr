...
- **Everyday-function ratings beat lab tests, but self-rating of "am I improving?" is unreliable.** ADHD carries a much-reported **positive illusory bias** (over-rating one's own competence — strongest in child studies, contested in mechanism; see [executive-function](../foundations/executive-function.md)), so global "how productive were you?" prompts measure mood weather, not benefit. Prefer validated scales anchored to concrete behaviors, and prefer behavioral evidence over self-report where you can get it.
...
- **Self-rating is biased upward.** ADHD carries a much-reported **positive illusory bias (PIB)** — a tendency to over-estimate one's own competence and performance relative to objective criteria. The pattern is robust in child studies, but its mechanism is contested — recent work suggests it may partly reflect imprecise self-knowledge rather than inflation (see [executive-function](../foundations/executive-function.md)) — and it is *not re-verified against a source in this pass*. A global "how productive did you feel today?" prompt captures self-esteem weather and mood-congruent distortion far more than it captures benefit.
